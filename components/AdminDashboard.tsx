...
import { AnalyticsEcosystem } from './AnalyticsEcosystem';
...
type AdminTab = 'overview' | 'users' | 'communities' | 'feedback' | 'playout' | 'agent-controller' | 'news-production' | 'analytics' | 'settings';

const ADMIN_VALID_TABS: AdminTab[] = ['overview', 'users', 'communities', 'feedback', 'playout', 'agent-controller', 'news-production', 'analytics', 'settings'];
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ onNavigate }) => {
    ...
    const sidebarItems = [
        ...
        { id: 'analytics' as AdminTab, label: 'Analytics & Ecosystem', icon: Link2 },
            ...
            <div className="flex-1 overflow-y-auto pt-24 md:pt-28 p-6 md:p-12 custom-scrollbar">
                <div className="max-w-6xl mx-auto space-y-8">
                    ...
                    <div className={`flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 ${
                        activeTab === 'playout' || activeTab === 'agent-controller' || activeTab === 'news-production' || activeTab === 'analytics' ? 'hidden' : ''
                    }`}>
                        <div>
